...
#     """ ResNet18 (and custom classifier) with CBAM  """
#     def __init__(self, num_classes=1, freeze_backbone=True):
#         super().__init__()
...
#         # Replace the classifier head (same as BaseResNet18)
#         num_features = self.model.fc.in_features
#         self.model.fc = nn.Sequential(
#             nn.Linear(num_features, 128),
#             nn.ReLU(),
...
#     def forward(self, x):
#         # Copy of torchvision ResNet forward, with CBAM inserted
...
#         # Apply CBAM after final residual block
#         x = self.cbam(x)
